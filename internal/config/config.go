...
func Parse(args []string) (Config, error) {
	...
	set.BoolVar(&cfg.MetricsByNS, "metrics-by-namespace", cfg.MetricsByNS, "record acquire counters by namespace")
...
func applyEnvironment(cfg *Config) {
	...
	if value := os.Getenv("LOCKD_METRICS_BY_NAMESPACE"); value != "" {
		if parsed, err := strconv.ParseBool(value); err == nil {
			cfg.MetricsByNS = parsed
		}
	}
}
