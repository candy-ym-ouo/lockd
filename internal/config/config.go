...
func Parse(args []string) (Config, error) {
	...
	set.BoolVar(&cfg.TrackRequests, "track-requests", cfg.TrackRequests, "track recent request activity")
...
func applyEnvironment(cfg *Config) {
	...
	if value := os.Getenv("LOCKD_TRACK_REQUESTS"); value != "" {
		if parsed, err := strconv.ParseBool(value); err == nil {
			cfg.TrackRequests = parsed
		}
	}
}
